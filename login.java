...
class OnlineTestBegin extends JFrame implements ActionListener
{
    ...
    void set()
    {
        ...
        if(current==0)
        {
            l.setText("Que1: Which of these keywords is used to define interfaces in Java?");
            jb[0].setText("interface");jb[1].setText("Interface");jb[2].setText("intf");jb[3].setText("Intf");
        }
        if(current==1)
        {
            l.setText("Que2: Which of the following is a superclass of every class in Java?");
        ...
        if(current==4)
        {
            l.setText("Que5:  What will be the output of the following Java code?   class Output \n" +
                    "    {\n" +
                    ...
                    "         }\n" +
                    "    } ");
            jb[0].setText("3");jb[1].setText("0");jb[2].setText("4");jb[3].setText("3.0");
        }
        if(current==5)
        {
